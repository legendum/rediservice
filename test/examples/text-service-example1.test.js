...
const textExample = require( '../../examples/text-service-example1' );
...
describe( 'rediservice text service example', function () {
  ...
  it( 'should export 2 services, without running them', function(done) {
    ...
    assert.equal( 'function', typeof services['text1.join'] );
    assert.equal( 'function', typeof services['text1.caps'] );
